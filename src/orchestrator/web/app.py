...
class CreateSessionRequest(BaseModel):
    ...
    # Map of planning module id → whether it should be generated by the Planning Agent.
    # If absent, the workflow uses all 15 modules as enabled (the default).
    planning_modules: Optional[dict] = None
...
async def create_session(req: CreateSessionRequest):
    ...
    # Normalize planning_modules to {module_id: bool} for all 15 known modules.
    from ..agents.planning_models import default_plan_for_modules
    planning_modules = default_plan_for_modules(req.planning_modules or {})
